...
- PR preparation added a controlled folder loading/partial-results UI test and opt-in screenshot captures. The full API 36 suite now passes **22 Android tests**; ktlint also passes. Raw captures and reproduction instructions are in `docs/pr-audit/`.

...
object Settings {
    /**
     * Suffix of the preferences file that backup rules exclude (`backup_rules.xml`,
     * `data_extraction_rules.xml`): stored servers carry passwords and keys, and the FTP server
     * configuration carries its password.
     */
    ...
    val FTP_SERVER_WRITABLE: SettingLiveData<Boolean> =
        BooleanSettingLiveData(
            ...
            null,
            R.bool.pref_default_value_ftp_server_writable
        )

    val THEME_COLOR: SettingLiveData<ThemeColor> =
        EnumSettingLiveData(
            R.string.pref_key_theme_color,
            R.string.pref_default_value_theme_color,
    ...
    val MATERIAL_DESIGN_3: SettingLiveData<Boolean> =
        BooleanSettingLiveData(
            ...
            R.bool.pref_default_value_material_design_3
        )

    val NIGHT_MODE: SettingLiveData<NightMode> =
        EnumSettingLiveData(
            R.string.pref_key_night_mode,
            R.string.pref_default_value_night_mode,
    ...
    val BLACK_NIGHT_MODE: SettingLiveData<Boolean> =
        BooleanSettingLiveData(
            ...
            R.bool.pref_default_value_black_night_mode
        )

    val FILE_LIST_ANIMATION: SettingLiveData<Boolean> =
        BooleanSettingLiveData(
            R.string.pref_key_file_list_animation,
            R.bool.pref_default_value_file_list_animation
        )
    ...
    val ROOT_STRATEGY: SettingLiveData<RootStrategy> =
        EnumSettingLiveData(
            ...
            R.string.pref_default_value_root_strategy,

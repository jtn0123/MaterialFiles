...
fun ArchiveException.toFileSystemOrInterruptedIOException(file: Path): IOException = when {
...
class ArchiveExceptionInputStream(inputStream: InputStream, private val file: Path) :

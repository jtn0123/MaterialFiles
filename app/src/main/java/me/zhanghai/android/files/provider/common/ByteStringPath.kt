...
class ByteStringPath(private val byteString: ByteString) :
    Parcelable,
    Path {
    ...
    override fun getFileSystem(): FileSystem = throw UnsupportedOperationException()

    override fun isAbsolute(): Boolean = throw UnsupportedOperationException()

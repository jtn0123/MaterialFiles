...
class FileListViewModel : ViewModel() {
    ...
    fun resetTo(path: Path, state: Parcelable? = null) = trailLiveData.resetTo(path, state)

    /**
     * Whether this file list is the plain launcher one, whose location is saved and reopened. One
     * started to show a specific folder or to pick a file is not.
     */
    var remembersLastLocation = false

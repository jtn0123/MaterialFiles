...
open class RootFileSystem(fileSystem: FileSystem) :
    RemoteFileSystem(
    ...
    override fun getRootDirectories(): Iterable<Path> = throw AssertionError()

    override fun getFileStores(): Iterable<FileStore> = throw AssertionError()

    override fun supportedFileAttributeViews(): Set<String> = throw AssertionError()
